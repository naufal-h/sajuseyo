      ...
      <nav class="navbar">
        <div data-collapse="small" class="nav-bar navibar">
          <div class="wrapper nav-container page-container">
            <div class="logo-div">
              <a href="home.html" class="nav-logo w-inline-block w--current"
                ><img src="/assets/logo/logo.png" height="30" class="logo"
              /></a>
            </div>
            <nav role="navigation" class="nav-content navibar-menu">
              ...
              <div class="nav-menu">
                <button class="btn-pjg">
                  ...
                  <div style="margin-left: 7px">Cart</div>
            ...
            <div class="navbar__start">
              <nav class="nav">
                <ul class="nav__wrapper" style="list-style: none">
                  ...
                  <li class="nav__item"><a href="celebs.html">Celeb</a></li>
                  <li class="nav__item"><a href="deals.html">Deals</a></li>
                </ul>
              </nav>
            </div>
